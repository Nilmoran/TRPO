...
namespace Spacy
{
  ...
  public:
    ...
    template<typename T>
    static T call_method(PyObjectPtr p_method, const std::vector<PyObjectPtr>& p_args = std::vector<PyObjectPtr>())
    {
    ...
    template<typename T>
    static T call_method(PyObjectPtr p_obj, const std::string& p_method, const std::vector<PyObjectPtr>& p_args = std::vector<PyObjectPtr>())
    {
